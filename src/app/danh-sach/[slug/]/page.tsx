...
export default async function CategoryPage({ params, searchParams }: Props) {
    ...
    try {
        ...
        const titleSize = titleMap[slug] || "Danh sách phim";

        return (
            <div className="container" style={{ paddingTop: "2rem" }}>
                <h2 className="section-title">{titleSize}</h2>
                ...
                {pagination.total_page > 1 && (
                    <div className="flex gap-2 justify-center" style={{ marginTop: "3rem", paddingBottom: "2rem", flexWrap: "wrap" }}>
                        {currentPage > 1 && (
